...
assert_same('user@bu.edu.ph', validate_institutional_email('user@bu.edu.ph'), 'BU short domain accepted');
assert_throws(fn() => validate_institutional_email('user@gmail.com'), 'Only official', 'Gmail domain rejected');
assert_throws(fn() => validate_institutional_email('user@bicol-u.edu.ph.evil.com'), 'allowed', 'Lookalike domain rejected');
