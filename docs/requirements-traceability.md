...
| SRC-ERD-1A | Owner-designated original Phase 1A ERD image | Archived owner source | Found at `docs/database/erd-sources/phase-1a-original-paper-erd.png` | Structural authority for the Phase 1A source-fidelity stage; not claimed pixel-identical to the paper appendix. |
| SRC-ERD-1B | Owner-designated present Phase 1B ERD image | Archived owner source | Found at `docs/database/erd-sources/phase-1b-present-20-entity-erd.png` | Structural authority for the exact present 20-entity stage. |
...
The ERD rows below are now linked to the archived Phase 1A and Phase 1B structural sources (`SRC-ERD-1A`, `SRC-ERD-1B`) and the reconciliation record (`SRC-PHASE-1-RECON`). Their implementation statuses remain unchanged: archival and reconciliation do not create or approve database schema.

| Requirement ID | Requirement description | Requirement source | Current repository evidence | Current status | Expected implementation phase | Expected validation or evidence artifact | Related decision ID | Open issue or Owner decision |
|---|---|---|---|---|---|---|---|---|
| ERD-001 | Users | SRC-CAP-SAD, SRC-ERD-1A, SRC-ERD-1B, SRC-PHASE-1-RECON, SRC-FE-PROTO | Archived source diagrams show `User Account`; frontend auth service has mock users; backend has no users table | Prototype Only | Phase 1 | Phase 1 ERD approval artifact and later migration review | DEC-008, DEC-003 | Decide user identity model. |
| ERD-002 | Faculty | SRC-CAP-SAD, SRC-ERD-1A, SRC-ERD-1B, SRC-PHASE-1-RECON, SRC-FE-PROTO | Archived diagrams show `faculty` then `Faculty`; faculty role/approval remains prototype evidence | Prototype Only | Phase 1 | Phase 1 ERD approval artifact | DEC-008, DEC-006 | Decide faculty profile and assignment structure. |
| ERD-003 | Students | SRC-CAP-SAD, SRC-ERD-1A, SRC-ERD-1B, SRC-PHASE-1-RECON, SRC-FE-PROTO | Archived diagrams show Student; frontend `Student` type remains supporting evidence | Prototype Only | Phase 1 | Phase 1 ERD approval artifact | DEC-008, DEC-009 | Decide student academic identity fields. |
| ERD-004 | Courses or subjects | SRC-CAP-SAD, SRC-ERD-1A, SRC-ERD-1B, SRC-PHASE-1-RECON, SRC-FE-PROTO | Archived diagrams show Course and present Course_Components/Component; frontend is supporting evidence | Prototype Only | Phase 1 | Phase 1 ERD approval artifact | DEC-008, DEC-009 | Decide course, subject, term, and offering model. |
| ERD-005 | Sections | SRC-CAP-SAD, SRC-ERD-1A, SRC-ERD-1B, SRC-PHASE-1-RECON, SRC-FE-PROTO | Archived diagrams show Class_Section; frontend class IDs/names are supporting evidence | Prototype Only | Phase 1 | Phase 1 ERD approval artifact | DEC-009 | Decide section vs class offering boundaries. |
| ERD-006 | Enrollment | SRC-CAP-SAD, SRC-ERD-1A, SRC-ERD-1B, SRC-PHASE-1-RECON, SRC-FE-PROTO | Archived diagrams show Enrollment; frontend enrolled subjects are supporting evidence | Prototype Only | Phase 1 | Phase 1 ERD approval artifact | DEC-010 | Decide normalized enrollment records. |
| ERD-007 | Assessments | SRC-CAP-SAD, SRC-ERD-1A, SRC-ERD-1B, SRC-PHASE-1-RECON, SRC-FE-PROTO | Archived diagrams show Assessment and Student_Assessment_Grade; frontend types are supporting evidence | Prototype Only | Phase 1 | Phase 1 ERD approval artifact | DEC-011 | Decide assessment hierarchy and scoring model. |
| ERD-008 | Grades | SRC-CAP-SAD, SRC-ERD-1A, SRC-ERD-1B, SRC-PHASE-1-RECON, SRC-FE-PROTO | Archived diagrams show Student_Assessment_Grade and present Student_Term_Grade; backend grades remain absent | Prototype Only | Phase 1 | Phase 1 ERD approval artifact | DEC-011, DEC-012 | Decide computed vs stored grades and revisions. |
| ERD-009 | Retention | SRC-CAP-SAD, SRC-ERD-1A, SRC-ERD-1B, SRC-PHASE-1-RECON, SRC-FE-PROTO | Archived diagrams show Retention_Record and Retention_Risk; prototype status/logs remain supporting evidence | Prototype Only | Phase 1 | Phase 1 ERD approval artifact | DEC-013 | Decide policy versioning and history. |
| ERD-010 | Remedial records | SRC-CAP-SAD, SRC-ERD-1A, SRC-ERD-1B, SRC-PHASE-1-RECON, SRC-FE-PROTO | Archived diagrams show Remedial_Logs; general prototype is supporting evidence | Prototype Only | Phase 1 | Phase 1 ERD approval artifact | DEC-014 | Add first, second, and cost-recovery decisions. |
| ERD-011 | Attendance | SRC-CAP-SAD, SRC-ERD-1A, SRC-ERD-1B, SRC-PHASE-1-RECON, SRC-FE-PROTO | Archived diagrams show Attendance_Session and Attendance_Record; prototype types are supporting evidence | Prototype Only | Phase 1 | Phase 1 ERD approval artifact | DEC-015 | Decide attendance session and verification records. |
| ERD-012 | Devices | SRC-CAP-SAD, SRC-ERD-1B, SRC-PHASE-1-RECON, SRC-FE-PROTO | Present archived diagram shows Device; CCTV placeholder is supporting evidence | Owner Decision Required | Phase 1 | Phase 1 ERD approval artifact | DEC-015, DEC-019 | Decide camera/device registration needs. |
| ERD-013 | Facial templates | SRC-CAP-SAD, SRC-ERD-1A, SRC-ERD-1B, SRC-PHASE-1-RECON, SRC-REPO-DOCS, SRC-FE-PROTO | Archived diagrams show Student_Image and Facial_Template; lifecycle/retention remains unresolved | Owner Decision Required | Phase 1 | Phase 1 ERD approval artifact and privacy review | DEC-016, DEC-017, DEC-018 | Decide template/image storage and retention. |
| ERD-014 | Audit logs | SRC-CAP-SAD, SRC-ERD-1B, SRC-PHASE-1-RECON, SRC-REPO-DOCS, SRC-FE-PROTO | Present archived diagram shows Audit_Log; backend audit table remains absent | Prototype Only | Phase 1 | Phase 1 ERD approval artifact | DEC-007 | Decide append-only audit structure. |
