...
export function SignUp() {
  ...
  const emailValidation = useMemo(() => {
    ...
    return validateBicolUEmail(email);
  }, [email]);
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex items-center justify-center p-4 sm:p-6 md:p-8 relative overflow-hidden transition-colors duration-300">
      ...
      {/* Background Decorative Blur Blobs (Matching Login.tsx) */}
      ...
      <div className="w-full max-w-5xl bg-white dark:bg-slate-900 rounded-[32px] shadow-xl shadow-slate-100 dark:shadow-none border border-slate-200/30 dark:border-slate-800/80 overflow-hidden grid grid-cols-1 md:grid-cols-12 min-h-[600px] transition-all relative z-10 my-6">
        ...
        {/* Left Side: Lavender/Purple Branding Sidebar (Matching Login.tsx) */}
        <div className="md:col-span-5 bg-[#EAE5F8] dark:bg-accent-950/20 p-8 flex flex-col justify-between items-center text-center relative overflow-hidden">
          ...
          <div className="flex flex-col items-center my-auto">
            ...
            <div className="mt-6 p-4 rounded-2xl bg-white/60 dark:bg-slate-900/40 border border-accent-200/50 dark:border-accent-900/30 backdrop-blur-sm text-left max-w-xs space-y-2.5">
              <div className="flex items-center gap-2 text-xs font-bold text-accent-800 dark:text-accent-300 border-b border-accent-200/50 dark:border-accent-900/50 pb-2">
                <GraduationCap className="w-4 h-4 text-accent-600 dark:text-accent-400" />
                <span>Faculty Registration Portal</span>
              </div>
              <div className="flex items-start gap-2.5 text-xs text-slate-700 dark:text-slate-300">
                ...
                <span>Requires official Bicol University email</span>
              </div>
              <div className="flex items-start gap-2.5 text-xs text-slate-700 dark:text-slate-300">
                <Clock className="w-4 h-4 text-amber-600 dark:text-amber-400 shrink-0 mt-0.5" />
                <span>Subject to approval by the Office of the Dean</span>
              </div>
            </div>
          </div>

          {/* Bottom Security Footer */}
          <div className="pt-4 flex items-center gap-1.5 text-[10px] font-bold text-accent-600/60 dark:text-accent-500/60 uppercase tracking-wider">
            <ShieldCheck className="w-3.5 h-3.5" />
            <span>Secure Access Portal v1.0</span>
          </div>
        </div>

        {/* Right Side: Form / Confirmation Pane */}
              ...
              <form className="space-y-4" onSubmit={handleSubmit} noValidate>
                <div className="mb-4">
                  <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-accent-100/80 dark:bg-accent-950/50 text-accent-800 dark:text-accent-300 text-[10px] font-bold uppercase tracking-wider mb-2">
                    <GraduationCap className="w-3.5 h-3.5" /> Faculty Onboarding
                  </div>
                  ...
                  <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
                    Enter your official details. Account activation requires approval by the Dean.
                  </p>
                </div>
                ...
                {/* BU Email Address Field */}
                <div>
                  <div className="flex items-center justify-between mb-1.5">
                    <label className="block text-[11px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">
                      Official BU Email <span className="text-rose-500">*</span>
                    </label>
                    <span className="text-[10px] text-accent-600 dark:text-accent-400 font-semibold">
                ...
                <div className="pt-1">
                  <label className="flex items-start gap-2.5 cursor-pointer select-none">
                    ...
                    <span className="text-xs text-slate-500 dark:text-slate-400 leading-normal">
                      I agree to the{' '}
                      <span className="text-accent-600 dark:text-accent-400 font-semibold hover:underline">
                        Terms of Service
                      </span>{' '}
                      and{' '}
                      <span className="text-accent-600 dark:text-accent-400 font-semibold hover:underline">
                      ...
                      for official Bicol University faculty portals.
                    </span>
                  </label>
                </div>
